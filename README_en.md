...
| speed_test_filter_host | Use Host address for filtering during speed measurement, channels with the same Host address will share speed measurement data, enabling can greatly improve speed measurement speed, but may lead to inaccurate speed measurement results                                                                                                                                                                                       | 1                 |

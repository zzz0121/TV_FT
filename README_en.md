...
| open_rtmp              | Enable RTMP push function, use local bandwidth to improve the interface playback experience, it is recommended to enable when multiple people use it, it is not recommended to enable when used by one person, the workflow cannot enable this function                                                                                                                                                                          | False             |
